                                ...
                                <form role="form" method="post" action="{{ route('book.update', $book->id) }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Address" name="address" value="{{ $book->address }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Quantity</label>
                                            <input type="text" class="form-control" placeholder="Quantity" name="qty" value="{{ $book->qty }}">
                                        </div>
                                        <div class="form-group">
